...
UPDATES_CHANNEL = os.environ.get('UPDATES_CHANNEL', 'Doreamonfans')
...
async def genStr(_, msg: Message):
    if msg.chat.id in Credentials.BANNED_USERS:
        await bot.send_message(
            chat_id=msg.chat.id,
            text="You are Banned. Contact My [Support Group](https://t.me/disneyteamchat)",
    ...
    if update_channel:
        try:
            ...
            if user.status == "kicked":
               await bot.send_message(
                   chat_id=msg.chat.id,
                   text="Sorry Sir, You are Banned. Contact My [Support Group](https://t.me/disneyteamchat).",
                   parse_mode="markdown",
            ...
            await bot.send_message(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton("🤖 Join Updates Channel 🤖", url=f"https://t.me/disneygrou")
                        ]
                    ]
                ),
                parse_mode="markdown"
